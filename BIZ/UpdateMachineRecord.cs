...
class UpdateMacineRecord
{
   ...
   */
    ...
    */
    public void UpdateMacineRecordDrill(H3.IEngine engine, string objectID, string processPlanObjectid, H3.DataModel.BizObject automaticCal)
    {
        ...
        if (drillMachiningObj != null)     //   钻孔下机
        {
            ...
            //工件号
            recordObj[MachiningTaskRecord_WorkPieceNumber] = drillObj[Drill.WorkpieceNumber] + string.Empty;
            recordObj[MachiningTaskRecord_TaskNumber] = taskNum; //任务计数器
            recordObj[MachiningTaskRecord_Processor] = currentTask["F0000143"] + string.Empty; //加工者
            recordObj[MachiningTaskRecord_DepartmentName] = processor != null ? processor.DepartmentName : ""; //部门名称
            recordObj[MachiningTaskRecord_StartTime] = currentTask["F0000142"] + string.Empty; //加工开始时间
            ...
            recordObj[MachiningTaskRecord_DepartmentCode] = drillObj["F0000186"] + string.Empty;    //部门代码
                                                                                                    //版本号
            recordObj[MachiningTaskRecord_VersionNumber] = drillObj["F0000184"] + string.Empty;
            //部门多选
    ...
    **/
    ...
    string SamplingSubFlowSubTable_Processor = "F0000157";//取样子流程子表//加工者


    //粗车
    string Roughing_TableCode = "D001419Szzswrfsp91x3heen4dykgwus0";
    //粗车机加工
    string Roughing_Machining = "D001419F8cbba24c57a74ad99bd809ab8e262996";

    //精车
    string Finishing_TableCode = "D001419Sqy2b1uy8h8cahh17u9kn0jk10";
    //精车机加工
    string Finishing_Machining = "D001419Fd25eb8064b424ed9855ced1923841f1c";
    ...
    //工序名称
    string MachiningTaskRecord_SectionName = "F0000001";
    //产品规格
    string MachiningTaskRecord_ProductSpecification = "F0000003";
    //加工者
    string MachiningTaskRecord_Processor = "F0000011";
    //ID
    string MachiningTaskRecord_ID = "ID";
    //工件号
    string MachiningTaskRecord_WorkPieceNumber = "F0000040";
    //任务计数器
    string MachiningTaskRecord_TaskNumber = "F0000002";
    //任务类别
    string MachiningTaskRecord_TaskType = "F0000031";
    //部门名称
    string MachiningTaskRecord_DepartmentName = "F0000030";
    //开始时间
    string MachiningTaskRecord_StartTime = "StartTime";
    //设备名称
    string MachiningTaskRecord_DeviceName = "F0000007";
    //设备编号
    string MachiningTaskRecord_DeviceNumber = "F0000014";
    //设备类型
    string MachiningTaskRecord_DeviceType = "F0000041";
    //轧制方式
    string MachiningTaskRecord_RollingMode = "F0000024";
    //任务加工量
    string MachiningTaskRecord_WorkLoad = "F0000010";
    //加工结束时间
    string MachiningTaskRecord_EndTime = "EndTime";
    //产品名称
    string MachiningTaskRecord_ProductName = "F0000026";
    //车加工类别
    string MachiningTaskRecord_MachiningProcessingCategory = "F0000027";
    //钻加工类别
    string MachiningTaskRecord_DrillingProcessingCategory = "F0000025";
    //订单规格号
    string MachiningTaskRecord_OrderSpecifications = "ProductNum";
    //成品单重
    string MachiningTaskRecord_FinishedProductUnitWeight = "F0000017";
    //工件外径
    string MachiningTaskRecord_OutsideDiameter = "F0000016";
    //工件内径
    string MachiningTaskRecord_InsideDiameter = "F0000018";
    //工件总高
    string MachiningTaskRecord_TotalHeight = "F0000020";
    //工件片厚
    string MachiningTaskRecord_Thickness = "F0000019";
    //工件孔数
    string MachiningTaskRecord_HoleAmount = "F0000021";
    //工件孔径
    string MachiningTaskRecord_Aperture = "F0000022";
    //数据代码
    ...
    //实际加工耗时
    string MachiningTaskRecord_ActualProcessingTime = "F0000013";
    //申请加工难度
    string MachiningTaskRecord_ApplyAdjust = "F0000044";
    //设备系数
    string MachiningTaskRecord_DeviceCoefficient = "F0000008";
    //无设备工时
    string MachiningTaskRecord_NoDeviceTechHours = "F0000004";
    //工时
    ...
    //产品名称
    string ProductParameter_ProductName = "F0000067";
    //产品车加工类别
    string ProductParameter_ProductMachiningCategory = "F0000004";
    //产品规格
    string ProductParameter_ProductSpecification = "F0000003";
    //产品钻加工类别
    string ProductParameter_ProductDrillingCategory = "F0000006";
    //订单规格编号
    string ProductParameter_OrderSpecificationNumber = "F0000073";
    //成品单重
    string ProductParameter_FinishedProductUnitWeight = "F0000014";
    //工件外径
    string ProductParameter_OuterDiameter = "F0000076";
    //工件内径
    string ProductParameter_InnerDiameter = "F0000077";
    //工件总高
    string ProductParameter_TotalHeight = "F0000078";
    //工件片厚
    string ProductParameter_SliceThickness = "F0000079";
    //工件孔数
    string ProductParameter_NumberOfHoles = "F0000080";
    //工件孔径
    string ProductParameter_HoleDiameter = "F0000081";
}
